...
function statusNote(status) {
  if (status === "aprovado") {
    return (
      ...
      "<ol>" +
      '<li>Acesse <a href="https://www.instagram.com/accounts/manage_access/" target="_blank" rel="noopener noreferrer">instagram.com</a> e entre na sua conta.</li>' +
...
/* Professional finishing: normalize Instagram usernames while typing. */
document.addEventListener("DOMContentLoaded", () => {
  const input = document.getElementById("igTesterUsernameInput");
  if (!input) return;
